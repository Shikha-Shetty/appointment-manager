...
We have used local storage in browser to retrieve the newly added appointments. The appointment consists of the following fields- Appointment by the name, Appointment description, Date and Time.
